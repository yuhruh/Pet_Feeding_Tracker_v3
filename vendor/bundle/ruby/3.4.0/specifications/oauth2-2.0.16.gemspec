...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/ruby-oauth/oauth2/issues", "changelog_uri" => "https://github.com/ruby-oauth/oauth2/blob/v2.0.16/CHANGELOG.md", "discord_uri" => "https://discord.gg/3qme4XHNKN", "documentation_uri" => "https://www.rubydoc.info/gems/oauth2/2.0.16", "funding_uri" => "https://github.com/sponsors/pboling", "homepage_uri" => "https://oauth2.galtzo.com/", "mailing_list_uri" => "https://groups.google.com/g/oauth-ruby", "news_uri" => "https://www.railsbling.com/tags/oauth2", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/ruby-oauth/oauth2/tree/v2.0.16", "wiki_uri" => "https://gitlab.com/ruby-oauth/oauth2/-/wiki" } if s.respond_to? :metadata=
  ...
  s.add_development_dependency(%q<kettle-dev>.freeze, ["~> 1.1".freeze, ">= 1.1.9".freeze])
